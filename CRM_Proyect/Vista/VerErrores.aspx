<%@ Page Language="C#" MasterPageFile="~/Vista/Home.Master" AutoEventWireup="true" CodeBehind="VerErrores.aspx.cs" Inherits="CRM_Proyect.Vista.VerErrores" %>
     ...
     <br />
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="tablaVerErrores" class="table table-responsive  table-bordered table-hover">
                <thead>
                <tr>
                  <th>ID</th>
                  <th>Título</th>
